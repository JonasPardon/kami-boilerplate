...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _kami_core_mixins_toastMixin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @kami-core/mixins/toastMixin */ "../../kami-packages/kami-core/src/resources/js/mixins/toastMixin.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'page-detail',
  mixins: [_kami_core_mixins_toastMixin__WEBPACK_IMPORTED_MODULE_0__["default"]],
  props: {
    data: {
      type: Object
    },
  ...
  methods: {
    savePage: function savePage() {
      ...
      var url = this.isCreate ? '/admin/pages' : "/admin/pages/".concat(this.page.id);
      ...
      _c("div", { staticClass: "page-actions" }, [
        ...
        _c(
          ...
          [
            _c(
              "custom-btn",
              { attrs: { icon: "save" }, on: { click: _vm.savePage } },
              [_vm._v("Save")]
            )
          ],
          1
